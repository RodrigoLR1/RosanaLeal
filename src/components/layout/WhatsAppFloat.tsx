  ...
  return (
    ...
    >
      <a
        ...
        className="group relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-[var(--color-moss-700)] text-[var(--color-sand-50)] shadow-[0_8px_24px_rgba(32,81,62,0.35)] hover:bg-[var(--color-moss-800)] hover:-translate-y-0.5 transition-all duration-300"
      >
        ...
        />
        {/* WhatsApp — FontAwesome brand icon. Path único sólido, sem fill-rule. */}
        <svg
          width="30"
          height="30"
          viewBox="0 0 448 512"
